...
function estateagency_add_post_type () : void
{
    ...
    register_post_type("testimonial", [
        ...
        "labels" => [
            ...
            "archives"                 => __("Partner testimonial", "estateagency"),
            "attributes"               => __("Testimonial attributes", "estateagency"),
            "insert_into_item"         => __("Insert into testimonial", "estateagency"),
            "uploaded_to_this_item"    => __("Uploaded to this testimonial", "estateagency"),
            "filter_items_list"        => __("Filter testimonials list", "estateagency"),
            "items_list_navigation"    => __("Testimonials list navigation", "estateagency"),
            "items_list"               => __("Testimonials list", "estateagency"),
            "item_published"           => __("Testimonial published.", "estateagency"),
            "item_published_privately" => __("Testimonial published privately.", "estateagency"),
            "item_reverted_to_draft"   => __("Testimonial reverted to draft.", "estateagency"),
            "item_scheduled"           => __("Testimonial scheduled.", "estateagency"),
            "item_updated"             => __("Testimonial updated.", "estateagency"),
        ],
        "public" => true,
        "hierarchical" => false,
        "exclude_from_search" => true,
